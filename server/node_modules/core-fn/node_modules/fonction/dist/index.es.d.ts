 ...
 * @public
 */
type Head<T extends readonly unknown[] | string> = T extends "" ? "" : T extends string ? String2Array<T> extends [
...
type Last<T extends string | readonly unknown[]> = T extends "" ? "" : T extends string ? String2Array<T> extends [
    ...
    never,
    ...String2Array<T>
][String2Array<T>["length"]] : T extends never[] | [
] ? undefined : T extends readonly [
    ...infer _,
    infer L
